...
const TrainingPlan = () => {
  ...
  const openImageModal = (exerciseName) => {
    const imageMap = {
      ...
      //front lever
      "Warm Up: Band Pull-Aparts": require('../assets/images/Band_Pull_Aparts.png'),
      "Activation: Horizontal Retractive Scapula Pull Up": require('../assets/images/Horizontal_Retractive_Scapula_Pull_Up.png'),
      "Skill Development: Incline Australian Pull Ups": require('../assets/images/Incline_Australian_Pull_Ups.png'),
      "Skill Development: Band Assisted Tuck Front Lever Hold": require('../assets/images/Band_Assisted_Tuck_Front_Lever_Hold.png'),
      "Skill Development: Knee Raises": require('../assets/images/Knee_Raises.png'),
      "Resistance Training: Retractive Scapula Band Rows": require('../assets/images/Retractive_Scapula_Band_Rows.png'),
      "Cool Down: Pseudo Planche Scapula Push Ups": require('../assets/images/Pseudo_Planche_Scapula_Push_Ups.png'),
      "Skill Development: Regular Australian Pull Ups": require('../assets/images/Regular_Australian_Pull_Ups.png'),
      "Skill Development: Tuck Front Lever Hold": require('../assets/images/Tuck_Front_Lever_Hold.png'),
      "Skill Development: Tuck Dragon Flag Raises": require('../assets/images/Tuck_Dragon_Flag_Raises.png'),
      "Skill Development: Advanced Tuck Front Lever Hold": require('../assets/images/Advanced_Tuck_Front_Lever_Hold.png'),
      "Skill Development: Tuck Front Lever Raises": require('../assets/images/Tuck_Front_Lever_Raises.png'),
      "Skill Development: Advanced Tuck Dragon Flag Raises": require('../assets/images/Advanced_Tuck_Dragon_Flag_Raises.png'),
    };
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  const generateMidBeginnerFrontLeverFirstHalf = () => [
    ...
    { name: "Skill Development: Tuck Dragon Flag Raises", reps: 2, sets: 5, rest: "3 min" },
    { name: "Skill Development: Knee Raises", reps: 3, sets: 7, rest: "3 min" },
    { name: "Resistance Training: Retractive Scapula Band Rows", reps: 5, sets: 4, rest: "1 min" },
    { name: "Cool Down: Pseudo Planche Scapula Push Ups", reps: 3, sets: 5, rest: "1 min" },
  ];
  ...
  const generateLateBeginnerFrontLeverFirstHalf = () => [
    ...
    { name: "Skill Development: Tuck Dragon Flag Raises", reps: 2, sets: 8, rest: "3 min" },
  ...
  const generateLateBeginnerFrontLeverSecondHalf = () => [
    ...
    { name: "Skill Development: Advanced Tuck Dragon Flag Raises", reps: 1, sets: 10, rest: "3 min" },
    { name: "Skill Development: Tuck Front Lever Raises", reps: 2, sets: 10, rest: "2 min" },
    { name: "Resistance Training: Retractive Scapula Band Rows", reps: 5, sets: 4, rest: "1 min" },
    { name: "Cool Down: Pseudo Planche Scapula Push Ups", reps: 3, sets: 5, rest: "1 min" },
  ];  
